...
public class NotificationStatusFactory {
    ...
    static {
        ...
        levels.put(i++,new ImmutablePair<>("render_notification","svc"));
...
//        String destination = faker.internet().emailAddress();
        ...
        notificationStatus.setCp_code(String.format("kafka_v2_perf_%s_%s}", comm_id, upmid));
        ...
        notificationStatus.setEventtype("country_ONE (ONE)");
        notificationStatus.setEnvironment("perf");
        notificationStatus.setTag("ONE");
        ...
        notificationStatus.setAppteam((stepNumber==3) ? "Notifications");
